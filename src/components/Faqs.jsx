        ...
        <div className="w-full max-w-3xl space-y-6">
          {faqs.map((faq, index) => (
            ...
            >
              ...
              >
                <h3
                  className={`text-lg sm:text-xl font-medium ${openQuestion === index ? "text-gray-900" : "text-gray-800"
                    }`}
                >
                  {faq.question}
                </h3>
                <span
                  className={`text-xl transform transition-transform ${openQuestion === index ? "rotate-180" : ""
                    }`}
                >
                  {openQuestion === index ? "−" : "+"}
                </span>
